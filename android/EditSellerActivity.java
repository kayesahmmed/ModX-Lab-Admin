...
public class EditSellerActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		t_coin = findViewById(R.id.t_coin);
		...
		materialbutton1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				// SECURITY: credential update now goes through the "updateSellerCredentials" Cloud Function.
				AdminApi.updateSellerCredentials(key.getString("key", ""), edittext1.getText().toString(), edittext2.getText().toString(), new AdminApi.Callback() {
					@Override
		...
		t_b.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				// SECURITY: status toggle now goes through the "toggleSellerStatus" Cloud Function.
				final boolean _activate = t_status.getText().toString().equals("Activate");
				AdminApi.toggleSellerStatus(key.getString("key", ""), _activate, new AdminApi.Callback() {
					@Override
					public void onSuccess(java.util.HashMap<String, Object> data) {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(key.getString("key", ""))) {
					...
					if (_childValue.containsKey("coin")) {
						t_coin.setText(_childValue.get("coin").toString());
					}
