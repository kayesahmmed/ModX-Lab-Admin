...
public class UserListFragmentActivity extends Fragment {
	...
	public View onCreateView(@NonNull LayoutInflater _inflater, @Nullable ViewGroup _container, @Nullable Bundle _savedInstanceState) {
		View _view = _inflater.inflate(R.layout.user_list_fragment, _container, false);
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
				...
				public void onClick(View _view) {
					...
					dialog.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface _dialog, int _which) {
							// SECURITY: delete now goes through the "deleteUser" Cloud Function.
							final int _delPos = (int)(_position);
							AdminApi.deleteUser(list.get(_delPos), new AdminApi.Callback() {
								@Override
					...
					if (_data.get((int)_position).get("status").toString().equals("true")) {
						...
						dialog.setPositiveButton("Deactivate", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface _dialog, int _which) {
								if (_data.get((int)_position).containsKey("key")) {
									// SECURITY: status change now goes through the "toggleUserStatus" Cloud Function.
									AdminApi.toggleUserStatus(_data.get((int)_position).get("key").toString(), false, new AdminApi.Callback() {
										@Override
										public void onSuccess(java.util.HashMap<String, Object> data) {}
										@Override
						...
						dialog.setPositiveButton("Activate", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface _dialog, int _which) {
								if (_data.get((int)_position).containsKey("key")) {
									// SECURITY: status change now goes through the "toggleUserStatus" Cloud Function.
									AdminApi.toggleUserStatus(_data.get((int)_position).get("key").toString(), true, new AdminApi.Callback() {
										@Override
										public void onSuccess(java.util.HashMap<String, Object> data) {}
										@Override
										public void onError(String message) { SketchwareUtil.showMessage(getApplicationContext(), "Failed: " + message); }
			...
			edit.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
					intent.setClass(getContext().getApplicationContext(), EditUserActivity.class);
